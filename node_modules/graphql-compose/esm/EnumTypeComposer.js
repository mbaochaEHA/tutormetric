...
export class EnumTypeComposer {
  ...
  constructor(graphqlType, schemaComposer) {
    ...
    this._gqcFields = convertEnumValuesToConfig(this._gqType.getValues(), this.schemaComposer); // alive proper Flow type casting in autosuggestions for class with Generics
  ...
  clone(newTypeNameOrTC) {
    ...
    cloned._gqcFields = mapEachKey(this._gqcFields, fieldConfig => _objectSpread({}, fieldConfig, {
