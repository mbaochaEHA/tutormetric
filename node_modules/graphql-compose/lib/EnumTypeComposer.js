...
class EnumTypeComposer {
  ...
  constructor(graphqlType, schemaComposer) {
    ...
    this._gqcFields = (0, _configToDefine.convertEnumValuesToConfig)(this._gqType.getValues(), this.schemaComposer); // alive proper Flow type casting in autosuggestions for class with Generics
  ...
  reorderFields(names) {
    ...
    this._gqcFields = _objectSpread({}, orderedFields, {}, fields);
    return this;
  }
  ...
  clone(newTypeNameOrTC) {
    ...
    cloned._gqcFields = (0, _misc.mapEachKey)(this._gqcFields, fieldConfig => _objectSpread({}, fieldConfig, {
